        ...
        <Card extra={"w-full h-full p-4"}>
            ...
            <div className="mb-auto flex flex-col items-center justify-center">
                ...
                <p className="px-5 text-center text-base font-normal text-gray-600 md:!px-0 xl:!px-8">
                    Monitor how much AI-processed memory is stored and indexed.
                </p>
            </div>
            ...
            <div className="flex flex-col">
                <div className="flex justify-between">
                    <p className="text-sm font-medium text-gray-600">18.2 GB</p>
                    <p className="text-sm font-medium text-gray-600">40 GB Limit</p>
                </div>
                <div className="mt-2 flex h-3 w-full items-center rounded-full bg-lightPrimary dark:!bg-navy-700">
                    <span className="h-full w-[45%] rounded-full bg-brand-500 dark:!bg-white" />
                </div>
            </div>
        </Card>
    );
